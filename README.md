# 2025 DB Final Presentation (Working on it)
...
This project is a simple web application that allows users to manage their sql backend with ease. It was built to demonstrate the use of mssql and php together with both front-end and backend in a simple set-up.
...
Once the application is running, open your web browser and go to `http://localhost`.
